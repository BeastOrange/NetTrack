...
def det_demo(args, text_prompt, model, seq_dir, video_name):
    ...
    # for ext in ['*.jpg', '*.jpeg', '*.png', '*.bmp']:
      # img_list.extend(glob(os.path.join(seq_dir, ext)))
...
if __name__ == '__main__':
    ...
    # model
    parser.add_argument('--config_file', type=str, default="C:/Users/Ru1ple/Desktop/Deep Learning Method/NetTrack-main/weights/groundingdino/GroundingDINO_SwinB_cfg.py")
    parser.add_argument('--weights', type=str, default="C:/Users/Ru1ple/Desktop/Deep Learning Method/NetTrack-main/weights/groundingdino/groundingdino_swinb_cogcoor.pth")
    ...
    parser.add_argument('--seq_dir', type=str, default="C:/Users/Ru1ple/Desktop/Deep Learning Method/NetTrack-main/data/big")
    parser.add_argument('--text_prompt', type=str, nargs='+', default='foreign object')
    ...
    # output data
    parser.add_argument('--res_dir', type=str, default="C:/Users/Ru1ple/Desktop/Deep Learning Method/NetTrack-main/output")
